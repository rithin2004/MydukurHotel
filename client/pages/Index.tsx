...
export default function Index() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "All our items are prepared fresh daily using traditional cooking methods.",
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description:
        "We provide professional catering services for events, parties, and special occasions with authentic South Indian cuisine.",
    },
  ];
...
Thank you for your time and I look forward to hearing from you soon!`;
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-20 mt-20 sm:mt-12 md:mt-16 lg:mt-24 xl:mt-32">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover our most beloved creations that have made Mydukur Hotel a
      ...
      <section id="menu" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Savor the authentic flavors of South India with our carefully
              crafted traditional dishes
            </p>
          </div>
      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-8">
            ...
            <div className="mt-16 bg-white bg-opacity-10 rounded-2xl p-8">
              <div className="flex justify-center mb-6">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className="w-8 h-8 text-yellow-300 fill-current"
                  />
                ))}
              </div>
              <blockquote className="text-2xl italic mb-4">
                "The most authentic South Indian food I've ever tasted. Mydukur
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Visit us today and experience the authentic taste of South Indian
              cuisine
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Serving authentic South Indian cuisine with traditional recipes
                and warm hospitality for over 25 years.
              </p>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center">
            <p className="text-gray-300">
              © 2025 Mydukur Hotel. All rights reserved. Made with ❤️ for
              authentic South Indian cuisine lovers.
            </p>
          </div>
        </div>
      </footer>
